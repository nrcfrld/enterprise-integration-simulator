...
export function RelatedResource({ type, id, label, onOpen }: { type: "order" | "package" | "shipment" | "warehouse" | "delivery"; id?: string; label?: string; onOpen?: (detail: DetailRequest) => void }) {
